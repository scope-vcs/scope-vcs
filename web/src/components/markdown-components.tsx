...
const SCALE_CLASSES = {
  ...
  document: {
    a: 'decoration-muted-foreground/70 hover:decoration-foreground',
    blockquote: 'my-6 border-border-strong pl-4',
    ...
    list: 'my-5',
    p: 'my-4',
    pre: 'my-6 rounded-lg border border-border border-l-2 border-l-[var(--border-strong)] p-4 leading-6 shadow-[var(--shadow-card)]',
