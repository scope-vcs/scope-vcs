...
export type ErrorCode = "attachment_upload_expired" | "bad_request" | "cli_upgrade_required" | "conflict" | "forbidden" | "internal" | "not_found" | "payload_too_large" | "protected_path" | "service_unavailable" | "too_many_requests" | "unauthorized";
...
export type SessionCapabilities = { read: boolean, can_read_private_files: boolean, can_push: boolean, can_change_file_visibility: boolean, can_manage_members: boolean, can_delete_repo: boolean, };
