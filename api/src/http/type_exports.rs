...
use scope_api_contract::{
    ...
    ConfigVisibility, CreatePushIntentRequest, CreatePushIntentResponse, CreateRepoRequest,
    CreateRepoResponse, CreateRequestAttachmentMediaGrantRequest,
    ...
    PrepareRequestAttachmentResponse, RemoveRequestInviteeRequest, RepoChangeEvent, RepoChangeKind,
    RepoConfig, RepoConfigHistory, RepoConfigResponse, RepoConfigVisibility,
    RepoConfigVisibilityRule, RepoInitResponse, RepoLifecycleState, RepoSummaryResponse,
    ...
    RepositoryRunJobState, RepositoryRunStepResponse, RepositoryRunSummaryResponse,
    RepositoryRunTerminalReason, RepositoryRunTrigger, RequestActivityPageResponse,
    RequestActorRole, RequestActorSummaryResponse, RequestAttachmentDerivativeKind,
    ...
    RequestAttentionResponse, RequestAttentionState, RequestAudience,
    RequestAutoMergeIntentResponse, RequestAutoMergeIntentStatus, RequestAutoMergeResponse,
    RequestAutoMergeStopReason, RequestCheckEvaluationState, RequestCheckResponse,
    RequestChecksResponse, RequestCloseResponse, RequestDetailResponse, RequestDiscussionAnchor,
...
pub(crate) fn export_api_contract(output_path: &Path, schema_output_path: &Path) {
    ...
    let type_declarations = contract_declarations!(
        ...
        RequestAutoMergeIntentResponse,
