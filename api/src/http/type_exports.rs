...
use scope_api_contract::{
    ...
    RequestAttentionResponse, RequestAttentionState, RequestAudience, RequestCheckEvaluationState,
    RequestCheckResponse, RequestChecksResponse, RequestCloseResponse, RequestDetailResponse,
    RequestDiscussionAnchor, RequestDiscussionAnchorInput, RequestDiscussionChangesResponse,
