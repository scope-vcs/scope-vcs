...
use scope_api_contract::{
    ...
    RunChangeKind, RunResponse, RunState, SessionIdentity, StartRequestRequest,
...
fn api_route_template_declarations() -> String {
    let routes = [
        ...
        ("repoRequestAttachments", routes::REPO_REQUEST_ATTACHMENTS),
        (
        ...
        ("repoRequestAttachment", routes::REPO_REQUEST_ATTACHMENT),
        (
